...
character.tittle = "Lady of Winterfelll";
...
alert{
`I am ${character.characterName} and my tittle is ${character.tittle}
...
character.greet = function() {
alert(
`She is ${character.characterName} and her tittle is ${character.tittle}`);
...
character.characterAdult = function(){
// true => !true
//false => !false
...
charcter[keyName] = "Maisie Williams";
